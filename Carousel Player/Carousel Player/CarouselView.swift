...
//  Carousel Player
//
//  Created by Jasur Salimov on 8/3/22.
//
...
//    let albums = ["image", "image", "image", "image", "image", "image"]
//    var body: some View {
//        let items: [Item] = albums.map { Item(image: Image($0)) }
//        ACarousel(items, spacing: -50) { item in
//                  item.image
//                      .resizable()
//                      .scaledToFit()
//                      .frame(height:300)
